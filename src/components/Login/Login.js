...
const Login = ({
  ...
  const { formValue, error, handleChange, resetValidation, isValid } =
    useForm();
      ...
      <form className="login__form" onSubmit={handleSubmit}>
        <div className="login__inputs">
          <div className="login__input">
            ...
            />
            <span className="name-field-error login__span">
              {error.email || ""}
            </span>
          </div>
          <div className="login__input">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <span className="profession-field-error login__span">
              {error.password || ""}
            </span>
          </div>
        </div>
